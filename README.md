[![Build Status](https://dev.azure.com/mydevops03/user03devops/_apis/build/status/monolith-user03devops-CI?branchName=master)](https://dev.azure.com/mydevops03/user03devops/_build/latest?definitionId=2&branchName=master)
